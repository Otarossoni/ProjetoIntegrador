...
const ComentarioForm = (props) => {
  ...
  const handleInputChange = (event) => {
    ...
    props.setComentario({ ...props.comentario, [name]: value });
  };
            ...
            <div className="field col-6 md:col-6">
              <span className="p-float-label">
                <InputText
                  ...
                  defaultValue={props.comentario.titulo}
            ...
            <div className="field col-6 md:col-6">
              <span className="p-float-label">
                <InputText
                  ...
                  defaultValue={props.comentario.descricao}
                  onChange={handleInputChange}
                />
            ...
            <div className="col-6 md:col-6">
              <span className="p-float-label">
                <AutoComplete
                  name="promocao_id"
                  dropdown
                  value={props.comentario.promocao_id}
            ...
            <div className="field col-6 md:col-6">
              <span className="p-float-label">
                <AutoComplete
                  name="usuario_id"
                  dropdown
                  value={props.comentario.usuario_id}
