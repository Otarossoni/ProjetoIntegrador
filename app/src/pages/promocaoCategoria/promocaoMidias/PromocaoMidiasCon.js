...
import PromocaoMidiasList from "./PromocaoMidiasList";
import PromocaoMidiasForm from "./PromocaoMidiasForm";
import PromocaoMidiasSrv from "./PromocaoMidiasSrv";
...
function PromocaoMidiasCon() {
  ...
  const salvar = () => {
    ...
    if (promocao._id == null) {
      PromocaoMidiasSrv.incluir(promocao)
        .then((response) => {
          setEditando(false);
          onClickAtualizar();
          toastRef.current.show({
      ...
      // alteração
      PromocaoMidiasSrv.alterar(promocao)
        .then((response) => {
          setEditando(false);
          onClickAtualizar();
          toastRef.current.show({
...
export default PromocaoMidiasCon;
